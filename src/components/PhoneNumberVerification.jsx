...
function PhoneNumberVerification({ recaptcha,setAvatarImg,isOpenSignUp,setIsOpenSignUp }) {
    ...
    const checkIfClickedOutsideSign = e => {
        if (isOpenSignUp && outsideClickRefSign.current && !outsideClickRefSign.current.contains(e.target)) {
            ...
            <section className="absolute w-full h-full">
                <div className="container mx-auto px-4 h-full">
                    <div className="flex content-center items-center justify-center h-full">
                        ...
                        <div ref={outsideClickRefSign} className="relative px-4 w-full max-w-md h-full md:h-auto">
                            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <div className="flex justify-end p-2">
                                    <button onClick={() => setIsOpenSignUp(false)} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
                                ...
                                <div className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8">
                                    ...
                                    <div>
                                        <label htmlFor="tel" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Вашият телефонен номер</label>
                                        <PhoneInput
                                            international
                                    ...
                                    <div>
                                        <label htmlFor="code" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" >Вашият код</label>
                                        <input value={code} onChange={(e) => setCode(e.target.value)} placeholder='123456' className="bg-gray-50 border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white " required minLength='6' maxLength='6'/>
                                    </div>

                                    {inPhone ? 
                                    confirmationResult && (
                                        <button onClick={verifyCode} className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Влез а акаунта си</button>
                                    ) : 
                                        <button onClick={signInWithPhoneNumber} className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Изпрати код</button>  
                                    }                      
                                </div>
                            </div>
                        </div>
