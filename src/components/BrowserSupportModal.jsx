...
function BrowserSupportModal({setBrowserMode,browserMode}) {
    ...
    useEffect(() => {
		const checkIfClickedOutsideSign = e => {
		  if (browserMode && outsideClickRefBrowser.current && !outsideClickRefBrowser.current.contains(e.target)) {
            ...
            <div ref={outsideClickRefBrowser} className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div className="p-6 space-y-6">
                    <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400 text-center">
                        ...
                        <br/>Поддържани браузъри: <div className='flex justify-center items-center'>
                        <img src="https://img.icons8.com/color/48/000000/chrome--v1.png"/> <img src="https://img.icons8.com/color/48/000000/ms-edge-new.png"/>
                        </div>
                    </p>
                </div>
            </div>
